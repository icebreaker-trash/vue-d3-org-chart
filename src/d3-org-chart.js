...
export class OrgChart {
  ...
  downloadImage ({ node, scale = 2, isSvg = false, save = true, onAlreadySerialized = d => { }, onLoad = d => { } }) {
    ...
    url = 'data:image/svg+xml; charset=utf8, ' + encodeURIComponent(serializeString(svgNode))
    ...
    function serializeString (svg) {
      ...
      const walker = document.createTreeWalker(svg, window.NodeFilter.SHOW_ELEMENT, null, false)
